...
public class PLCApplicationFactory {
    private Properties properties;

    public PLCApplicationFactory() {
        properties = new Properties();
    }

    protected PLCApplicationFactory addProperty(String propertyName, String value) {
    ...
    public PLCApplication createApplication() throws Exception {
        Properties copy = new Properties();
        copy.putAll(properties);
        validate(copy, null);
        Resources resources = buildResources(copy);
        return new PLCApplication(resources.getOWLOntologySource(), resources.getTransformationRuleSet());
    }

    public PLCApplication createApplication(OWLOntologySourceHook ontologySourceHook) throws Exception {
        Properties copy = new Properties();
        copy.putAll(properties);
