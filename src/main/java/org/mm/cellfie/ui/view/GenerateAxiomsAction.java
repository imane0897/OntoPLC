...
public class GenerateAxiomsAction implements ActionListener {
      ...
      public void actionPerformed(ActionEvent e) {
            try {
                  ...
                  // Store OntoPLC logging to a file
      ...
      private File getLoggingFile() {
            ...
            return new File("/Users/aym/Downloads", "OntoPLC.log");
      }
      ...
      private String getLogHeader() {
            ...
            sb.append("\n");
            sb.append("PLCFile source: ").append(container.getWorkbookFileLocation());
            sb.append("\n");
            sb.append("Transformation rules: ").append(
                        container.getRuleFileLocation().isPresent() ? container.getRuleFileLocation().get() : "N/A");
            sb.append("\n");
            return sb.toString();
      }
      ...
      private void showAxiomPreviewDialog(Set<OWLAxiom> axioms, String logMessage) throws CellfieException {
            ...
            try {
                  ...
                  case ADD_TO_NEW_ONTOLOGY:
                        ...
                        OWLOntology newOntology = modelManager.createNewOntology(id,
