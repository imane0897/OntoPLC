...
public class OWLObjectFactory implements MappingMasterParserConstants {
    ...
    public OWLAnnotationAssertionAxiom createOWLAnnotationAssertionAxiom(OWLAnnotationProperty ap,
            OWLAnnotationSubject as, OWLAnnotationValue value) {
    ...
    public OWLObjectPropertyAssertionAxiom createOWLObjectPropertyAssertionAxiom(OWLObjectProperty op,
    ...
    /*
     * Handles the retrieval of OWL entities from the input ontology given its name.
     * All these methods below will throw an exception if the input entity name
    ...
    /*
     * Handles the retrieval of OWL entities from the input ontology given its label
     * name (or display name). The retrieval uses a simple mapping created at
     * initial where each entity's display name is mapped to its OWLEntity object.
     * All these methods below will throw an exception if the input label name
     * doesn't exist in the map.
     */

    public Optional<OWLEntity> getOWLEntityFromDisplayName(String displayName, Optional<String> languageTag)
